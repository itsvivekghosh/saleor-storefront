...
export interface OrderDetailsByToken_orderByToken_lines_variant_attributes_attribute {
...
export interface OrderDetailsByToken_orderByToken_lines_variant_attributes_values {
...
export interface OrderDetailsByToken_orderByToken_lines_variant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: OrderDetailsByToken_orderByToken_lines_variant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (OrderDetailsByToken_orderByToken_lines_variant_attributes_values | null)[];
}
...
export interface OrderDetailsByToken_orderByToken_lines_variant_product_productType {
...
export interface OrderDetailsByToken_orderByToken_lines_variant_product {
  ...
  productType: OrderDetailsByToken_orderByToken_lines_variant_product_productType;
}
...
export interface OrderDetailsByToken_orderByToken_lines_variant {
   ...
   */
  attributes: OrderDetailsByToken_orderByToken_lines_variant_attributes[];
