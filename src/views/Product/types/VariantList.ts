...
export interface VariantList_productVariants_edges_node_product_variants_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface VariantList_productVariants_edges_node_product_variants_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface VariantList_productVariants_edges_node_product_variants_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface VariantList_productVariants_edges_node_product_variants_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: VariantList_productVariants_edges_node_product_variants_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: VariantList_productVariants_edges_node_product_variants_pricing_priceUndiscounted_net;
}

export interface VariantList_productVariants_edges_node_product_variants_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface VariantList_productVariants_edges_node_product_variants_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface VariantList_productVariants_edges_node_product_variants_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: VariantList_productVariants_edges_node_product_variants_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: VariantList_productVariants_edges_node_product_variants_pricing_price_net;
}

export interface VariantList_productVariants_edges_node_product_variants_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: VariantList_productVariants_edges_node_product_variants_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: VariantList_productVariants_edges_node_product_variants_pricing_price | null;
}

export interface VariantList_productVariants_edges_node_product_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
...
export interface VariantList_productVariants_edges_node_product_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface VariantList_productVariants_edges_node_product_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: VariantList_productVariants_edges_node_product_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (VariantList_productVariants_edges_node_product_variants_attributes_values | null)[];
}

export interface VariantList_productVariants_edges_node_product_variants {
   ...
   */
  images: (VariantList_productVariants_edges_node_product_variants_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: VariantList_productVariants_edges_node_product_variants_pricing | null;
  /**
   * List of attributes assigned to this variant.
   */
  attributes: VariantList_productVariants_edges_node_product_variants_attributes[];
}
...
export interface VariantList_productVariants_edges_node_product {
   ...
   */
  variants: (VariantList_productVariants_edges_node_product_variants | null)[] | null;
}
