...
export interface Collection_products_edges_node_variants_images {
...
export interface Collection_products_edges_node_variants_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface Collection_products_edges_node_variants_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface Collection_products_edges_node_variants_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: Collection_products_edges_node_variants_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: Collection_products_edges_node_variants_pricing_priceUndiscounted_net;
}

export interface Collection_products_edges_node_variants_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface Collection_products_edges_node_variants_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface Collection_products_edges_node_variants_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: Collection_products_edges_node_variants_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: Collection_products_edges_node_variants_pricing_price_net;
}

export interface Collection_products_edges_node_variants_pricing {
   ...
   */
  priceUndiscounted: Collection_products_edges_node_variants_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: Collection_products_edges_node_variants_pricing_price | null;
}

export interface Collection_products_edges_node_variants_attributes_attribute {
...
export interface Collection_products_edges_node_variants_attributes_values {
...
export interface Collection_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: Collection_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (Collection_products_edges_node_variants_attributes_values | null)[];
}

export interface Collection_products_edges_node_variants {
   ...
   */
  images: (Collection_products_edges_node_variants_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: Collection_products_edges_node_variants_pricing | null;
  /**
   * List of attributes assigned to this variant.
   */
  attributes: Collection_products_edges_node_variants_attributes[];
}
...
export interface Collection_products_edges_node_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
...
export interface Collection_products_edges_node_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface Collection_products_edges_node_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: Collection_products_edges_node_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (Collection_products_edges_node_attributes_values | null)[];
}
...
export interface Collection_products_edges_node {
   ...
   */
  variants: (Collection_products_edges_node_variants | null)[] | null;
  /**
   ...
   */
  attributes: Collection_products_edges_node_attributes[];
}
