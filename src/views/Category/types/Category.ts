...
export interface Category_products_edges_node_variants_attributes_attribute {
...
export interface Category_products_edges_node_variants_attributes_values {
...
export interface Category_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: Category_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (Category_products_edges_node_variants_attributes_values | null)[];
}
...
export interface Category_products_edges_node_variants {
   ...
   */
  attributes: Category_products_edges_node_variants_attributes[];
}
